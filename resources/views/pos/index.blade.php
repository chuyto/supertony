...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function addToCart(product) {
            ...
            if (productInCart) {
                ...
                cart.push({
                    id: product.id,
                    name: product.name,
                    price: parseFloat(product.price), // Asegurarse de que el precio sea un número
                    quantity: 1,
                    total: parseFloat(product.price) // Asegurarse de que el total sea un número
                });
            }

            updateCartTable();
            updateCartTotals(); // Actualizar subtotal y total
        }
        ...
        function updateCartTotals() {
            ...
            subtotal = parseFloat(subtotal); // Asegurarse de que subtotal sea un número
            let total = subtotal; // Aquí podrías añadir lógica para impuestos u otros cargos
