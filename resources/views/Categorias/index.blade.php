                            ...
                            <div class="px-4 sm:px-6 lg:px-8">
                                <div class="sm:flex sm:items-center">
                                    ...
                                    <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                                        <a href="{{ route('categorias.create') }}" class="block rounded-md bg-indigo-500 px-3 py-2 text-center text-sm font-semibold text-white hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">Agregar categoría</a>
                                    </div>
                                </div>
                            ...
                            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                <div class="sm:flex sm:items-start">
                                    ...
                                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                        <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">Eliminar categoria</h3>
                                        <div class="mt-2">
                                            <p class="text-sm text-gray-500">¿Estás seguro que deseas eliminar esta categoria? Esta acción no se puede deshacer.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="p-4">
                                <div class="flex items-start">
                                    ...
                                    <div class="ml-3 w-0 flex-1 pt-0.5">
                                        ...
                                        <p class="mt-1 text-sm text-gray-500">La categoria ha sido eliminado correctamente.</p>
                                    </div>
