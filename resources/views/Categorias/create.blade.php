                ...
                <form method="POST" action="{{ route('categorias.store') }}">
                    ...
                    <div class="px-6 py-4">
                        <div class="mb-4">
                            ...
                            <div class="mt-2">
                                <input type="text" name="categoria" id="categoria" class="block w-full rounded-md border-0 py-1.5 text-gray-900 dark:text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-700 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Nombre de la categoría">
                            </div>
                        </div>
