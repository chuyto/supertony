...
<div class="hidden sm:flex sm:items-center sm:ms-10 space-x-8">
    ...
    <div class="ms-3 relative">
        <x-dropdown align="right" width="48">
            ...
            <x-slot name="content">
                ...
                <x-dropdown-link href="{{ route('descuentos.index') }}">
                    {{ __('Descuentos') }}
                </x-dropdown-link>
                {{-- <x-dropdown-link href="{{ route('some.route2') }}">
                    {{ __('Descuentos') }}
                </x-dropdown-link> --}}
                {{-- <x-dropdown-link href="{{ route('some.route3') }}">
                    {{ __('Opción 3') }}
                </x-dropdown-link> --}}
            </x-slot>
        </x-dropdown>
    ...
    <div class="ms-3 relative">
        <x-dropdown align="right" width="48">
            ...
            <x-slot name="content">
                <x-dropdown-link href="{{ route('reportes.ventas.form') }}">
                    {{ __('Ventas') }}
                </x-dropdown-link>
                <x-dropdown-link href="{{ route('reportes.inventario.pdf') }}">
                    {{ __('Inventario') }}
                </x-dropdown-link>
                {{-- <x-dropdown-link href="{{ route('some.route2') }}">
                    {{ __('Descuentos') }}
